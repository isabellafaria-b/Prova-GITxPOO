...
Durante o desenvolvimento do sistema de gerenciamento de temporadas da FRC, um integrante da equipe encontrou um projeto no GitHub e deseja contribuir com melhorias, mas não possui permissão para alterar diretamente o repositório original.

Qual é a sequência correta de ações para enviar suas alterações ao proprietário do projeto?
